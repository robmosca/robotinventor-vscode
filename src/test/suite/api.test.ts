...
suite('_testing.API Test Suite', function () {
  suite('Waits for the _testing.API to be ready', function () {
    test('Waits for _testing.API to be ready', async function () {
      ...
      const api = new _testing.API(port);
